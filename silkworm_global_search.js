...
["stanza22.rq", {"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "DEFINE sql:select-option \"order\"\nPREFIX brso: <http://purl.jp/bio/10/brso/>\nPREFIX sio: <http://semanticscience.org/resource/>\nPREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>\nPREFIX skos: <http://www.w3.org/2004/02/skos/core#>\nPREFIX dcterms: <http://purl.org/dc/terms/>\nPREFIX foaf: <http://xmlns.com/foaf/0.1/>\nPREFIX bibo: <http://purl.org/ontology/bibo/>\nPREFIX obo: <http://purl.obolibrary.org/obo/>\nPREFIX prism: <http://prismstandard.org/namespaces/basic/2.0/>\nPREFIX bmpo: <http://purl.bioontology.org/ontology/BMPO/>\n\nSELECT DISTINCT\n    ?id\n    (group_concat(distinct ?phenotype;separator = \", \") AS ?phenotype)\n    (group_concat(distinct ?journal ;separator = \",\") AS ?journal)\n    (group_concat(distinct ?origin;separator = \", \") AS ?origin)\nFROM <http://iruddat2.nig.ac.jp:8120/silkworm_v4_0_0>\nWHERE {\n\n    # 系統リソース情報\n    ?Resource a brso:BiologicalResource ;\n        dcterms:identifier ?id ;\n        rdfs:label ?strain ;\n        dcterms:description ?description ;\n        ?stage ?StageResource .\n\n    OPTIONAL { ?Resource brso:derived_from ?origin . }\n    OPTIONAL { ?Resource dcterms:isReferencedBy ?journal . }\n    OPTIONAL {\n        ?Resource dcterms:reference ?b_reference .\n        \n        ?b_reference a bibo:Article ;\n            prism:publicationName ?puclication_name .\n\n        OPTIONAL {\n            ?b_reference dc:creater ?author .\n            ?author a foaf:Person;\n                foaf:name ?author_name .\n        }\n    }\n    \n    # ステージ別リソース情報\n    ?StageResource a ?StageResourceClass . \n    filter(?StageResourceClass = brso:BiologicalResourceEgg \n        || ?StageResourceClass = brso:BiologicalResourceLarva\n        || ?StageResourceClass = brso:BiologicalResourcePupa\n        || ?StageResourceClass = brso:BiologicalResourceAdult)\n\n    ?StageResource brso:resource_state ?b_resource_state .\n    ?b_resource_state rdfs:label ?resource_state .\n\n    # 遺伝子情報\n    OPTIONAL{\n        ?StageResource brso:genomic_feature ?b_genomic_feature .\n        \n        ?b_genomic_feature a brso:GenomicFeature ;\n            brso:has_genomic_segment ?b_genomic_segment .\n\n        ?b_genomic_segment a brso:GenomicSegment ;\n            dcterms:identifier ?gene_id ;\n            skos:altLabel ?synonym .\n\n        OPTIONAL{\n            ?b_genomic_segment rdfs:label ?gene_name.\n        }\n    }\n\n    # 形質特徴（結果出力用）\n    OPTIONAL{\n        ?StageResource sio:SIO_001279 ?b_phenotype_feature .\n        ?b_phenotype_feature a sio:SIO_010056 ;\n            rdfs:label ?phenotype .\n        filter(LANG(?phenotype) = '')\n    }\n    \n    # 表現型（検索用）\n    OPTIONAL{\n        ?StageResource sio:SIO_001279 ?b_phenotype_all .\n        ?b_phenotype_all a sio:SIO_010056 ;\n            rdfs:label ?phenotype_all .\n            \n        OPTIONAL{ ?b_phenotype_all dcterms:description ?phenotype_description. }\n        OPTIONAL{\n            ?b_phenotype_all dcterms:reference ?b_phenotype_reference .\n            ?b_phenotype_reference a bibo:Article ;\n                prism:publicationName ?phenotype_puclication_name .\n\n            OPTIONAL{\n                ?b_phenotype_reference dc:creater ?b_phenotype_author.\n                ?b_phenotype_author a foaf:Person ;\n                    foaf:name ?phenotype_author_name .\n            }\n        }\n    }\n\n    # 検索項目\n    {\n        { \n            ?Resource rdfs:label ?strain .  \n            ?strain bif:contains '\""
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"keyword") || (depth0 != null ? lookupProperty(depth0,"keyword") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"keyword","hash":{},"data":data,"loc":{"start":{"line":101,"column":35},"end":{"line":101,"column":46}}}) : helper))) != null ? stack1 : "")
    + "\"' . \n        } UNION { \n            ?Resource dcterms:description ?description .  \n            ?description bif:contains '\""
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"keyword") || (depth0 != null ? lookupProperty(depth0,"keyword") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"keyword","hash":{},"data":data,"loc":{"start":{"line":104,"column":40},"end":{"line":104,"column":51}}}) : helper))) != null ? stack1 : "")
    ...
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"keyword") || (depth0 != null ? lookupProperty(depth0,"keyword") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"keyword","hash":{},"data":data,"loc":{"start":{"line":110,"column":45},"end":{"line":110,"column":56}}}) : helper))) != null ? stack1 : "")
    + "\"' . \n        } UNION { \n            ?author foaf:name ?author_name .\n            ?author_name bif:contains '\""
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"keyword") || (depth0 != null ? lookupProperty(depth0,"keyword") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"keyword","hash":{},"data":data,"loc":{"start":{"line":113,"column":40},"end":{"line":113,"column":51}}}) : helper))) != null ? stack1 : "")
    + "\"' . \n        } UNION { \n            ?b_resource_state rdfs:label ?resource_state .\n            ?resource_state bif:contains '\""
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"keyword") || (depth0 != null ? lookupProperty(depth0,"keyword") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"keyword","hash":{},"data":data,"loc":{"start":{"line":116,"column":43},"end":{"line":116,"column":54}}}) : helper))) != null ? stack1 : "")
    + "\"' . \n        } UNION { \n            ?b_genomic_segment dcterms:identifier ?gene_id .\n            ?gene_id bif:contains '\""
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"keyword") || (depth0 != null ? lookupProperty(depth0,"keyword") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"keyword","hash":{},"data":data,"loc":{"start":{"line":119,"column":36},"end":{"line":119,"column":47}}}) : helper))) != null ? stack1 : "")
    ...
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"keyword") || (depth0 != null ? lookupProperty(depth0,"keyword") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"keyword","hash":{},"data":data,"loc":{"start":{"line":125,"column":38},"end":{"line":125,"column":49}}}) : helper))) != null ? stack1 : "")
    + "\"' .\n        } UNION {\n            ?b_phenotype_all rdfs:label ?phenotype_all .\n            ?phenotype_all bif:contains '\""
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"keyword") || (depth0 != null ? lookupProperty(depth0,"keyword") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"keyword","hash":{},"data":data,"loc":{"start":{"line":128,"column":42},"end":{"line":128,"column":53}}}) : helper))) != null ? stack1 : "")
    + "\"' .\n        } UNION {\n            ?b_phenotype_reference prism:publicationName ?phenotype_puclication_name .\n            ?phenotype_puclication_name bif:contains '\""
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"keyword") || (depth0 != null ? lookupProperty(depth0,"keyword") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"keyword","hash":{},"data":data,"loc":{"start":{"line":131,"column":55},"end":{"line":131,"column":66}}}) : helper))) != null ? stack1 : "")
    + "\"' .\n        } UNION {\n            ?b_phenotype_all dcterms:description ?phenotype_description.\n            ?phenotype_description bif:contains '\""
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"keyword") || (depth0 != null ? lookupProperty(depth0,"keyword") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"keyword","hash":{},"data":data,"loc":{"start":{"line":134,"column":50},"end":{"line":134,"column":61}}}) : helper))) != null ? stack1 : "")
    + "\"' .\n        }\n    }\n}\nORDER BY ?id";
},"useData":true}]
];
